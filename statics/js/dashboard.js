...
$(window).on('load', function() {
    ...
    // Network chart.md ( Morris Line Chart )
    // =================================================================
    ...
    var chart = Morris.Area({
        element : 'morris-chart.md-network',
        data: day_data,
        axes:false,
        xkey: 'elapsed',
        ykeys: ['value', 'b'],
    ...
    $.niftyNoty({
        ...
        message: 'You will notice that you now have an management menu<br> that appears on the right hand side.',
        container: 'floating',
        timer: 5000
    });
